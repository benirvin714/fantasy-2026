...
- **Bye weeks are now on every board player** (2026-07-28), derived at build time from `api.sleeper.app/schedule/nfl/regular/2026` (a team's bye = the week it plays no game), validated 32-teams-one-bye-each before it ships and nulled wholesale on any failure. 2026: 32/32, weeks 5–14. The field is `p.bye`; only the target rail renders it so far.
