...
(() => {
  ...
  const RK_TIP = "Starters: this slot's rank against the other nine teams. Bench: how many of the other nine he would start for.";
  ...
  function stacked(t) {
    return `<table class="rr-rtab" aria-label="${esc(t.owner)} roster">
        <thead><tr><th>Slot</th><th>Player</th><th>Pos</th><th class="num">Proj</th>
          <th class="num" title="${RK_TIP}">Rk</th></tr></thead>
    ...
    return `<div class="rr-rwrap">
      <div class="rr-rcol">
        ...
        <table class="rr-rtab" aria-label="${esc(t.owner)} starting lineup">
          <thead><tr><th>Slot</th><th>Player</th><th>Pos</th><th class="num">Proj</th>
            <th class="num" title="This slot's rank against the other nine teams">Rk</th></tr></thead>
      ...
      <div class="rr-rcol">
        ...
        <table class="rr-rtab rr-btab" aria-label="${esc(t.owner)} bench">
          <thead><tr><th>Player</th><th>Pos</th><th class="num">Proj</th>
            <th class="num" title="How many of the other nine teams he would start for, by recomputing each of their optimal lineups with him inserted">Starts</th></tr></thead>
  ...
  const html = (t, opts = {}) => opts.split ? split(t) : stacked(t);
