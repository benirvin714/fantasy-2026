...
5. **Counterparty intelligence** (league-tendencies.md): their trade history and habits (e.g. Sladsous has never traded — question a sudden offer; DiaperDutyDaddy deals constantly; DadKing is price-disciplined), their current trajectory, and what THEY think they're getting — use it to judge whether a counter is live.
